...
const SHOWTAPES = {
  ...
  "come-together-rfe": {
    ...
    description:
      "Full-length, beat-synced show for 'Come Together' (4:16). Entire show performed by the Rock Afire Explosion with dense per-character choreography.",
    duration: 256000,
    bitrate: 600,
    band: "rock",
    sequences: buildComeTogetherFullShow("rock"),
  },
  "munch-welcome": {
